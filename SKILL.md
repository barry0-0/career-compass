...
| 模块 | 类型 | 触发关键词 |
|------|------|-----------|
| **简历收集 & 优化** | Prompt 逻辑 | 简历、上传、优化 |
| **公司调研** | Prompt + 搜索 | 调研、分析、公司 |
| **职位搜索** | boss-cli | 搜索职位、同城 |
| **模拟面试** | Prompt + 搜索 | 面试、模拟 |
...
|------|-----------|
| 全面启动 | "帮我全面准备面试" |
| 简历优化 | "帮我看看简历有哪些可以优化的地方" |
| 上传简历 | "这是我的简历" / "我上传了简历" |
| 公司调研 | "帮我调研一下XX公司" / "XX公司怎么样" |
| 职位搜索 | "帮我搜索XX城市的XX岗位" |
| 模拟面试 | "帮我模拟一下XX公司的面试" |
| JD分析 | "帮我看看这个JD" / "这个岗位要求是什么" |
| Offer评估 | "帮我评估一下这个Offer" |
| 面试复盘 | "面试完了，帮我复盘一下" |
| 谈薪指导 | "马上要谈薪资了，帮我准备一下" |
| 自我介绍 | "帮我写一个自我介绍" |
| 离职原因 | "面试被问到离职原因怎么说" |
